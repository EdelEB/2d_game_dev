...
const Uint8 FRAME_COUNT = 2;   // This is here becuase the frame count in the sprite is in 2 locations and I don't feel like writing it in both every time
